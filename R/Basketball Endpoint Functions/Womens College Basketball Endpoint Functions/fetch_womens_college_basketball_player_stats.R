#' Safe nested data extraction helper function for womens_college_basketball player statistics
#'
...
fetch_player_info <- function(player_id) {
  ...
  url <- paste0("https://site.web.api.espn.com/apis/common/v3/sports/basketball/womens-college-basketball/athletes/", player_id)
...
#' @keywords internal
create_womens_college_basketball_season_summary_dataset <- function(data, player_id, player_info) {
...
#' Create detailed womens_college_basketball player game log data frame from ESPN API
#'
...
#' @keywords internal
create_womens_college_basketball_player_gamelog_dataset <- function(data, player_id, player_info) {
...
#' Fetch detailed womens_college_basketball player statistics using ESPN Web API
#'
#' Retrieves comprehensive statistics for a specific womens_college_basketball player from ESPN's Web API.
#' Extracts data directly from the seasonTypes structure - fast and reliable!
#'
#' @param player_id Character or numeric. womens_college_basketball player ID from ESPN
...
#'   as 'womens_college_basketball_player_stats_raw' for debugging purposes (default: FALSE).
#'
#' @return Invisibly returns a list with both datasets. The main purpose is global
#'   environment assignment of:
#'   \itemize{
#'     \item \code{womens_college_basketball_player_season_summary}: Season averages and totals by season type
#'     \item \code{womens_college_basketball_player_gamelog}: Game-by-game statistics organized by category
#'   }
#'
#' @details
...
#' fetch_womens_college_basketball_player_stats("3032977")
#'
#' # Check season summaries
#' print(womens_college_basketball_player_season_summary)
#'
#' # Check game log
#' head(womens_college_basketball_player_gamelog)
#'
#' # View regular season averages
#' reg_season_avg <- womens_college_basketball_player_season_summary[
#'   womens_college_basketball_player_season_summary$season_display_name == "2024-25 Regular Season" &
#'   womens_college_basketball_player_season_summary$stat_type == "avg", ]
#' print(reg_season_avg[, c("points", "total_rebounds", "assists", "field_goal_pct")])
#'
#' # View playoff games
#' playoff_games <- womens_college_basketball_player_gamelog[
#'   womens_college_basketball_player_gamelog$season_display_name == "2024-25 Postseason", ]
#' head(playoff_games[, c("category_display_name", "points", "total_rebounds", "assists")])
#'
#' # Calculate averages from game log
#' all_games <- womens_college_basketball_player_gamelog[!is.na(womens_college_basketball_player_gamelog$points), ]
...
#'
#' @export
fetch_womens_college_basketball_player_stats <- function(player_id, raw = FALSE) {
  ...
  url <- paste0("https://site.web.api.espn.com/apis/common/v3/sports/basketball/womens-college-basketball/athletes/",
                player_id, "/gamelog")
  ...
  if (isTRUE(raw)) {
    assign("womens_college_basketball_player_stats_raw", data, envir = .GlobalEnv)
  }
  ...
  gamelog <- create_womens_college_basketball_player_gamelog_dataset(data, player_id, player_info)
  assign("womens_college_basketball_player_gamelog", gamelog, envir = .GlobalEnv)
